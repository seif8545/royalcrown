...
export const rooms: Room[] = [
  {
    id: 1,
    title: "Royal Single Room",
    slug: "royal-single-room",
    description:
      "A compact 18 m² single — perfect for solo travellers exploring the pyramids on a budget.",
    longDescription:
      "A neat, well-appointed 18 m² room designed for the solo traveller. Soundproofed, air-conditioned, with free Wi-Fi and the complimentary toiletries you'll find in our larger categories.",
  ...
  },
  {
    ...
    slug: "royal-king-room",
    description:
      "A king-size bed in a quiet, modern 20 m² room with ensuite bathroom and the full hotel amenity set.",
    longDescription:
      "Our most popular room for solo and couple travellers who want space to spread out. The Royal King features a large king-size bed dressed in crisp linens, a bright ensuite bathroom, soundproofed windows and the full Royal Crown amenity set: TV, safety deposit box and complimentary toiletries.",
  ...
  {
    id: 3,
    title: "Standard Double Room with Twin Beds",
    slug: "standard-double-room-with-twin-beds",
    description:
      "A 20 m² room with two twin beds — ideal for friends or colleagues sharing.",
    longDescription:
      "Two twin beds in a quiet 20 m² room with a private ensuite, soundproofed windows and the full hotel amenity set. A reliable choice for friends, siblings, or business travellers sharing.",
  ...
  {
    id: 4,
    title: "Royal Twin Room with 2 Queen Beds",
    slug: "royal-twin-room-with-2-queen-beds",
    description:
      "A spacious 30 m² room with two queen beds — comfortable for sharing in style.",
    longDescription:
      "A genuinely spacious 30 m² room with two queen beds, bright modern furnishings, a generous work area, and a marble-finished bathroom with rainfall shower. The full Royal Crown amenity set comes as standard.",
    image: "/images/superior-double-room.jpg",
    pricePerNight: 24.75,
    currency: "USD",
    rating: 5,
  ...
  {
    id: 5,
    title: "Deluxe Double Room with Pyramids View",
    slug: "deluxe-double-room-with-pyramids-view",
    description:
      "An extra-large double bed and a Pyramids View — our most-loved room for couples in Giza.",
    longDescription:
      "An upgraded 20 m² room with an extra-large double bed and a window that frames the Giza pyramids. Dressed in warm tones with a marble-finished bathroom, TV and the full Royal Crown amenity set including free Wi-Fi.",
    ...
    maxGuests: 2,
    view: "Pyramids view",
    amenities: ["Pyramids view", ...HOTEL_BASE_AMENITIES],
  },
  {
    id: 6,
  ...
  {
    id: 7,
    title: "Deluxe Triple Room with Pyramids View",
    slug: "deluxe-triple-room-with-pyramids-view",
    description:
      "Our largest triple — 35 m² with a Pyramids View and flexible bed configuration.",
    longDescription:
      "An upgraded 35 m² triple room with a Pyramids View, configured either as three singles or one single plus a large double. Plenty of space for a small family or three friends, with the full Royal Crown amenity set and a generous bathroom.",
