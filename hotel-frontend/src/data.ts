...
export const rooms: Room[] = [
  {
    ...
    slug: "king-room",
    description:
      "A king-size double bed in a quiet, modern 20 m² room with ensuite bathroom and full hotel amenities.",
    longDescription:
      "Our most popular room for couples and solo travellers who want space to spread out. The Royal King features a large double bed dressed in crisp linens, a bright ensuite bathroom, soundproofed windows and the full Royal Crown amenity set: minibar, tea & coffee maker, smart TV, safety deposit box and complimentary toiletries.",
  ...
  },
  {
    ...
    longDescription:
      "A neat, well-appointed 18 m² room designed for the solo traveller. Choose between a single bed or two singles when available. Soundproofed, air-conditioned, with the same minibar, free Wi-Fi and complimentary toiletries you'll find in our larger categories.",
    image: "/images/single-bed-in-room.jpg",
    pricePerNight: 871,
    currency: "EGP",
    rating: 3,
    bookingUrl: BOOKING_URL,
    bedType: "1 single bed (or 2 on request)",
    size: "18 m²",
    maxGuests: 1,
    amenities: HOTEL_BASE_AMENITIES,
  },
  ...
  },
  {
    ...
    description:
      "An extra-large double bed and a city view — our most-loved room for couples in Giza.",
    longDescription:
      "An upgraded 20 m² room with an extra-large double bed and a window that frames the city. Dressed in warm tones with a marble-finished bathroom, smart TV and the full Royal Crown amenity set including minibar, espresso-style coffee maker and free Wi-Fi.",
